...
import ismaeldivita.bubblenavigation.util.onEndListener
import ismaeldivita.bubblenavigation.util.setColorStateListAnimator
import ismaeldivita.bubblenavigation.util.setCustomRipple
import ismaeldivita.bubblenavigation.util.updateLayoutParams
...
internal class VerticalMenuItemView(context: Context) : MenuItemView(context) {
    ...
    private val doubleSpace = resources.getDimension(R.dimen.bnv_double_space).toInt()
    ...
    init {
        View.inflate(getContext(), R.layout.bnv_vertical_menu_item, this)
